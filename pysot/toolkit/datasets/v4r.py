...
def ca():
    #path = '/home/mengjie/UAV_Tracking/UAVTrack112/V4RFlight112'
    # path = './test_dataset/V4RFlight112'
    path = os.path.normpath(os.path.join(os.getcwd(), '../test_dataset', 'V4RFlight112'))
    # os.path.normpath(os.path.join(os.getcwd(), '../test_dataset', args.dataset))
