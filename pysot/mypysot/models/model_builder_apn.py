...
from pysot.mypysot.models.loss_apn import select_cross_entropy_loss, weight_l1_loss,l1loss,IOULoss
from pysot.mypysot.models.backbone.alexnet import AlexNet
from pysot.mypysot.models.utile_apn import APN,clsandloc
import numpy as np
from pysot.mypysot.datasets.anchortarget_apn import AnchorTarget3
import torch
...
class ModelBuilderAPN(nn.Module):
    ...
    def getcenter(self,mapp):
        ...
        anchor=np.zeros((x.shape[0],size**2,4))
        # print('anchor shape', anchor.shape)
        # print('cfg.TRAIN.SEARCH_SIZE', cfg.TRAIN.SEARCH_SIZE)
        # print('cfg.TRAIN.SEARCH_SIZE//2', cfg.TRAIN.SEARCH_SIZE//2)
    ...
    # def get_overall_loss(self,data):
    #     with torch.no_grad():
